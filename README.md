...
<h3 id = '#files'>Бази даних</h3>
    <p>Бази даних має в собі такі моделі:</p>
    <ul>
        <li>User — дані користувачів та зв'язані з ними(адреси, замовлення)</li>
        <li>Product — продукти(дроні та тепловізори) та їх ціна, кількість та знижка</li>
        <li>Address — повна адреса користувача/ки</li>
        <li>Order — список продуктів у замовленні та замовник(користувач/ка)</li>
        <li>Order_product — таблиця-зв'язок між замовленнями та продуктами</li>
    </ul>
